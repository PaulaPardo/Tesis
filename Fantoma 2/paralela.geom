...
:VOLU mesh BOX $pixel_medios $pixel_medios $grosor_pixel_z G4_CADMIUM_TELLURIDE
:PLACE_PARAM mesh 1 mesh_container PHANTOM 256 256 1 $pixel $pixel 2.0*$grosor_pixel_z
